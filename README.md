...
![LatestEstimateFor](https://img.shields.io/badge/latest_estimate_for-2026--01--22_14:17:08-green)

## Definitions, Vision and Big-Picture

See [The Colombo Traffic Index (CTI) - Understanding the Bigger Picture](README.VISION.md)

## Colombo Traffic Index (CTI) = 1.90x

![images/CTI.ttr_traffic_index.png](images/CTI.ttr_traffic_index.png)

### Average CTI by Time of Day

![images/CTI.ttr_by_time_of_day.png](images/CTI.ttr_by_time_of_day.png)

### Average Speed by Day of Week

![images/CTI.speed_by_day_of_week.png](images/CTI.speed_by_day_of_week.png)
