...
Location.BAMBALAPITIYA = Location(
    ...
    details="Bambalapitiya Junction on Galle Road",
)
Location.BORELLA = Location(
    name="Borella",
    latlng=LatLng(6.910882574522934, 79.88789773709671),
    details="Ayurveda Junction on Sri Jayewardenepura Mawatha",
)
Location.DEMATAGODA = Location(
    name="Dematagoda",
    latlng=LatLng(6.943175860321491, 79.87820817923517),
    details="Southside of Dematagoda Canal Bridge, on A1/Baseline Road",
)
